...
class Exercise(models.Model):
    ...
    setup_steps = models.TextField(blank=True)
    execution_steps = models.TextField(blank=True)
    common_mistakes = models.TextField(blank=True)
    coaching_cues = models.TextField(blank=True)
    prescription_strength = models.CharField(max_length=120, blank=True)
    prescription_hypertrophy = models.CharField(max_length=120, blank=True)
    prescription_endurance = models.CharField(max_length=120, blank=True)
